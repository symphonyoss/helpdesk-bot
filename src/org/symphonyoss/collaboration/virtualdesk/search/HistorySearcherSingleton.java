...
public class HistorySearcherSingleton
{
	...
	public static void setHistorySearcher(HistorySearcher historySearcher)
	{
		HistorySearcherSingleton.historySearcher = historySearcher;
	}
}
