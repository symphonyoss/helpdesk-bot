...
import org.symphonyoss.AgentInfo;
import org.symphonyoss.AgentSelector;
	...
	public void assignAgent(MultiMap helpRequest, AsyncCallback<AgentInfo> asyncCallback) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				String[] agents = { "Matt matt.harper@symphonyoss.com", "Aaron jignesh@symphonyoss.com",
						"Jignesh jignesh@symphonyoss.com", };
