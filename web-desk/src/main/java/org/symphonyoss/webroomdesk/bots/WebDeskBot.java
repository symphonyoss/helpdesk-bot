...
import org.symphonyoss.webroomdesk.listeners.chat.MemberAliasListener;
...
import org.symphonyoss.webroomdesk.listeners.web.WebRegistrationListener;
...
public class WebDeskBot implements ChatServiceListener {
    ...
    public void setupBot() {
        try {
            ...
            helpBotSession.setHelpSession(helpSession);
    ...
    private void setupWeb() {
        ...
        webService.registerListener(new WebRegistrationListener(symClient, helpSession, helpClientListener));
    }
