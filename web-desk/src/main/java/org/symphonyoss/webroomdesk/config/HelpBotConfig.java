...
package org.symphonyoss.webroomdesk.config;
...
public final class HelpBotConfig {
    ...
    public final static String SET_ALIAS = "helpbot.command.setalias";
    public final static String TOGGLE_ALIAS = "helpbot.command.togglealias";
